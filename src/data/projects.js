...
export const projects = [
 {
  ...
  {
  id: "proj-02",
  poster: "/projects/datainsight-ai.png",
  title: "DataInsight AI — Upload Any Dataset. Get AI-Powered Insights.",
  category: "AI Data Analytics",
  description:
    "Built a full-stack AI-powered analytics platform that lets users upload CSV and Excel datasets, clean and explore data, perform automated EDA, generate interactive visualizations, detect outliers, uncover correlations, perform root-cause and what-if analysis, train ML models, and generate AI-driven insights, recommendations, and reports.",
  stack: [
    "React",
    "Node.js",
    "Express.js",
  ...
  metrics: [
    { label: "Data Sources", value: "CSV / Excel / DB / API" },
    { label: "Analytics", value: "EDA + ML + AI" },
    { label: "Insights", value: "Automated" },
  ],
  href: "https://github.com/shivasharma9475/DataInsight_AI",
  demo: "https://data-insight-ai-phi.vercel.app/",
},
